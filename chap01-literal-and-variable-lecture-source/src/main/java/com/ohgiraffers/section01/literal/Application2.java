...
public class Application2 {
    public static void main(String[] args) {
        ...
        System.out.println(1.23 / 10.0);
        System.out.println(1.23 % 1.0);         // 실수는 정확하지 않고 근사값이다
        ...
        /* 목차. 2. 문자의 연산 */
        /* 필기. (문자와 정수)의 연산은 (정수와 정수)의 연산과 같다(유니코드 기반의 숫자로 변환) */
        ...
        System.out.println("hello" + "world");          // 문자열간의 연산은 덧셈(이어붙이기)만 가능
...
//        System.out.println("hello" % "world");
        ...
        /* 설명. 이항연산자들의 묶음에서 좌측부터 이항씩 연산하면 이해할 수 있다 */
        System.out.println(123 + 3 + "helloworld" + 123 + 3);       // 결과 : 126helloworld1233

        /* 설명. 묹열 뒤에 숫자를 활용한 연산을 쓰게 되면 소괄호(())를 써서 우선순위를 높여 연산해야한다*/
