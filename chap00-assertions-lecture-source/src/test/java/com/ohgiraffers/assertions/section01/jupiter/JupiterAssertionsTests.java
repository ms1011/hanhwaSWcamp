...
public class JupiterAssertionsTests {
    ...
    /* 수업목표. Junit5에서 제공하는 Assertions 에서 제공하는 메소드에 대해 이해하고 활용할 수 있다 */
...
//        Assertions.assertEquals(expected, result, 1);
        Assertions.assertEquals(expected, result, "일치하지 않습니다");
    ...
    public void testAssertNotEqualsWithInstance() {
