...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 설명. 기본자료형을 Wrapper 클래스 자료형으로 변환할 수 있다 (boxing) */
        ...
        /* 설명. 기본자료형과 Wrapper 클래스는 자동으로 박싱 및 언박싱이 일어난다 (auto-boxing, auto-unboxing) */
...
//        System.out.println(" equals 비교 : " + (integerTest.equals(integerTest2)));
        System.out.println("intergerTest 주소 : " + System.identityHashCode(integerTest));
        System.out.println("intergerTest2 주소 : " + System.identityHashCode(integerTest2));
    ...
    public static void anythingMethod(Object obj) { // 10 -> Integer (auto-boxing) -> Object (다형성)
        System.out.println("obj = " + obj);     // Object의 toString()이 아닌 Integer의 toString()이 실행 됨(동적 바인딩)
    }
