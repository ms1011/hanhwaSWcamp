...
//        System.out.println("태어난 월 : " + (birthDay.get(2) + 1));     // get() 메소드로 반환받은 값에 +1에 해줘야 우리가 생각하는 월의 개념이 된다
        System.out.println("태어난 월 : " + (birthDay.get(Calendar.MONTH) + 1));     // get() 메소드로 반환받은 값에 +1에 해줘야 우리가 생각하는 월의 개념이 된다
//        System.out.println("태어난 일 : " + birthDay.get(5));
        ...
        /* 설명. SimpleDateFormat 활용하기 (java.util.Date형으로 변환 후 활용) */
