...
public class Application {
    public static void main(String[] args) {
         ...
         *  하지만 단순히 물려받아 재사용하는 개념보다 부모클래스의 개념을 확장(extends)하는데 더 의미가 있으며
         ...
         *    1-2. 부모 클래스만 수정해도 자식 클래스를 전체에 적용된다 (유지보수 측면)
         *   2. 클래스 간의 계층 관계가 형성되며 다형성의 문법적인 토대가 된다
         *
         * 필기.
         *  상속의 단점
         *   1. 부모 클래스의 기능을 추가/변경할 시 자식 클래스가 정상적으로 작동하게 될 지 예측이 힘들다
         *      (경우에 따라 유지보수에 악영향을 미칠 수 있다)
         *   2. 부모 클래스에서는 의미 있고 중요했던 기능이 자식 클래스에서는 무의미할 수 있다 (불필요한 멤버가 추가되기 때문)
         *      (불필요한 멤버가 추가되기 때문)
         *
         * 필기.
         *  메소드 오버라이딩이란?
         ...
         *
         * 필기.
         *  장점과 단점을 고려했을 때, 상속은 오용의 가능성이 있기 때문에 IS-A 관계로 구분되는 경우에만
         *  잘 고려하여 적용해야 한다
         *  (IS-A 관계 vs HAS-A 관계)
        * */
