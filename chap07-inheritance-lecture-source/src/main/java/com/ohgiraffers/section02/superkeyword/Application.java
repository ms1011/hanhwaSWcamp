...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        Product product2 = new Product("p01", "플레이데이터", "JAVA", 1000, new java.util.Date());
        ...
        Computer computer3 = new Computer("S-01234", "구글", "픽셀", 1000000, new java.util.Date(), "퀄컴 스냅드래곤", 512, 16, "안드로이드");
