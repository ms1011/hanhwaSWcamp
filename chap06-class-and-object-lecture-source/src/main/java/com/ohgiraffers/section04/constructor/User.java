...
public class User {
    ...
    * */
    ...
    /* 필기. 생성자와 같은 클래스 내부에 거의 필수적으로 들어가는 요소를 생성하는 단축키는 alt + insert 이다 */
    ...
    public User(String id, String pwd, String name, Date enrollDate) {
        ...
        /* 필기. 생성자 안의 this.은 해당 생성자를 통해 생성됨 객체에 접근하는 것이다 */
        /* 필기. 일반적으로 필드의 변수명과 매개변수명이 동일하므로 반드시 this.를 명시해야 한다 */
        /* 필기. 생성자 안의 this()는 해당 클래스의 다른 생성자를 사용하는 것이다 */
//        this.id = id;
//        this.pwd = pwd;
//        this.name = name;
//        this();                       // this()를 통한 다른 생성자 활동은 다른 하나의 생성자만 활용 가능하다
        this(id, pwd, name);
