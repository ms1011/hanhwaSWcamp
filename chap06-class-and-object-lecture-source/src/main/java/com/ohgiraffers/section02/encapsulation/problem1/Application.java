...
public class Application {
    public static void main(String[] args) {
        ...
        /* 설명. 몬스터 정보 출력 */
        System.out.println("monster1의 이름 : " + monster1.name);  // 참조연산자를 통해 값 출력
        System.out.println("monster1의 체력 : " + monster1.hp);    // 참조연산자를 통해 값 출력
        ...
        System.out.println("monster2의 이름 : " + monster2.name);  // 참조연산자를 통해 값 출력
        System.out.println("monster2의 체력 : " + monster2.hp);    // 참조연산자를 통해 값 출력
